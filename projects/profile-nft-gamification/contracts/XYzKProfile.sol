 ...
 */
contract XYzKProfile is AccessControl, ERC721Holder {
    ...
    uint256 public numberXYzKToReactivate;
    uint256 public numberXYzKToRegister;
    uint256 public numberXYzKToUpdate;
    ...
    constructor(
        IBEP20 _xYzKToken,
        uint256 _numberXYzKToReactivate,
        uint256 _numberXYzKToRegister,
        uint256 _numberXYzKToUpdate
    ) public {
        xYzKToken = _xYzKToken;
        numberXYzKToReactivate = _numberXYzKToReactivate;
        numberXYzKToRegister = _numberXYzKToRegister;
        numberXYzKToUpdate = _numberXYzKToUpdate;
    ...
    function createProfile(uint256 _teamId, address _nftAddress, uint256 _tokenId) external {
        ...
        xYzKToken.safeTransferFrom(_msgSender(), address(this), numberXYzKToRegister);
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        xYzKToken.safeTransferFrom(_msgSender(), address(this), numberXYzKToUpdate);
    ...
    function reactivateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        xYzKToken.safeTransferFrom(_msgSender(), address(this), numberXYzKToReactivate);
     ...
     * Callable only by owner admins.
     */
    function updateNumberXYzK(
        uint256 _newNumberXYzKToReactivate,
        uint256 _newNumberXYzKToRegister,
        uint256 _newNumberXYzKToUpdate
    ) external onlyOwner {
        numberXYzKToReactivate = _newNumberXYzKToReactivate;
        numberXYzKToRegister = _newNumberXYzKToRegister;
        numberXYzKToUpdate = _newNumberXYzKToUpdate;
    }

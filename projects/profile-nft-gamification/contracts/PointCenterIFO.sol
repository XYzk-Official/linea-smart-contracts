...
contract PointCenterIFO is Ownable {
    ...
    constructor(address _xYzKProfileAddress, uint256 _maxViewLength) public {
    ...
    function getPoints(address _contractAddress) external {
        ...
        bool isUserActive = xYzKProfile.getUserStatus(senderAddress);

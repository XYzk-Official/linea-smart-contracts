...
contract IFOPool is Ownable, Pausable {
    ...
    struct UserIFOInfo {
        ...
        uint256 lastActionBalance; // staked xYzK numbers (not include compoud xYzK) at last action
        uint256 lastValidActionBalance; // staked xYzK numbers in ifo valid period
     ...
     * @param _lastValidActionBalance: staked xYzK number at last action.
     ...
     * @param _amount:the xYzK amount that need be add or sub
